...
| Tier               | Dostawca                   | Cost                     | Quota Reset      | Best For                          |
| ------------------ | -------------------------- | ------------------------ | ---------------- | --------------------------------- |
| **💳 SUBSCRIPTION** | Claude Code (Pro)          | $20/mo                   | 5h + weekly      | Already subscribed                |
|                    | Codex (Plus/Pro)           | $20-200/mo               | 5h + weekly      | OpenAI users                      |
|                    | Gemini CLI                 | **FREE**                 | 180K/mo + 1K/day | Everyone!                         |
|                    | Drugi pilot GitHuba        | $10-19/mo                | Monthly          | GitHub users                      |
...
|                    | DeepSeek V3.2              | $0.27/$1.10 per 1M       | Żadne            | Best price/quality reasoning      |
|                    | xAI Grok-4 Fast            | **$0.20/$0.50 per 1M** 🆕 | Żadne            | Fastest + tool calling, ultralow  |
|                    | xAI Grok-4 (standard)      | $0.20/$1.50 per 1M 🆕     | Żadne            | Reasoning flagship from xAI       |
|                    | Mistral                    | Free trial + paid        | Cena ograniczona | European AI                       |
|                    | OpenRouter                 | Pay-per-use              | Żadne            | 100+ models aggr.                 |
...
|                    | Kimi K2.5 (Moonshot API) 🆕 | Pay-per-use              | Żadne            | Direct Moonshot API access        |
...
|                    | Scaleway AI 🆕              | **$0** (1M tokens total) | Cena ograniczona | EU/GDPR, Qwen3 235B, Llama 70B    |
...
| Model               | Przedrostek | limit         | Limit stawki          |
| ------------------- | ----------- | ------------- | --------------------- |
...
| Tier       | Limit dzienny | Limit stawki | Notatki                                                |
| ---------- | ------------- | ------------ | ------------------------------------------------------ |
...
| Tier      | Limit dzienny     | Limit stawki     | Notatki                                     |
| --------- | ----------------- | ---------------- | ------------------------------------------- |
| Bezpłatny | **1M tokens/day** | 60K TPM / 30 RPM | World's fastest LLM inference; resets daily |
...
| Tier      | Limit dzienny | Limit stawki     | Notatki                                   |
| --------- | ------------- | ---------------- | ----------------------------------------- |
| Bezpłatny | **14.4K RPD** | 30 RPM per model | No credit card; 429 on limit, not charged |
...
| Model                         | Przedrostek | Daily Free Quota | Notatki                 |
| ----------------------------- | ----------- | ---------------- | ----------------------- |
...
| Model      | Przedrostek | Limit stawki | Provider Behind    |
| ---------- | ----------- | ------------ | ------------------ |
...
| Tier      | Daily Neurons | Equivalent Usage                        | Notatki                 |
| --------- | ------------- | --------------------------------------- | ----------------------- |
| Bezpłatny | **10,000**    | ~150 LLM resp / 500s audio / 15K embeds | Global edge, 50+ models |
...
| Tier      | Free Quota    | Location     | Notatki                             |
| --------- | ------------- | ------------ | ----------------------------------- |
| Bezpłatny | **1M tokens** | 🇫🇷 Paris, EU | No credit card needed within limits |
...
| Dostawca         | Free Credits           | Best Model                                   | Limit stawki                 |
| ---------------- | ---------------------- | -------------------------------------------- | ---------------------------- |
...
| Transkrypcja dźwięku    | `/v1/audio/transcriptions` — 7 providers (Deepgram Nova 3, AssemblyAI, Groq Whisper, HuggingFace, ElevenLabs, OpenAI, Azure), auto-language detection, MP4/MP3/WAV support |
...
| niestandardowe | Custom JS function returns true/false            | `(output) => output.length > 10` |
...
- 🔗 **OpenCode Integration** — Native provider support for the OpenCode AI
  coding IDE
- 🔗 Podłączenie do TRAE[x1] Integracji[x1] — Pełna obsługa frameworku TRAE do
  rozwoju AI
- 📦 **Interfejs API w kształtach plików[x13X] — Ayncchrne pliki w formie plików
  w formie **bulk requests[x13X]
- 🎯 Wdrożenie **Routingu opartego na tagu[x21X] — Dla nieodłączono Routedni w
  zalożonych na **custom tags** i **metadata[x21X]
- 💰 **Najtańsza Strategia[x24X] — Wybor automatyczny najtaiejszego dostępnego
  dostawcy

> 📝 Pełne specyfikacje dotyczące funkcji dostępne są w
> [`docs/new-features/`](docs/new-features/) (217 ogółem zdefiniowsanych
> spsycyfikacji)
...
[![Współtwórcy](https://contrib.rocks/image?repo=diegosouzapw/OmniRoute&max=100&columns=20&anon=1)](https://github.com/diegosouzapw/OmniRoute/graphs/contributors)

### Jak Współpracować

1. Zarówno repository
2. Tworzenie gałęzi na podstawie `git checkout -b feature/amazing-feature`
3. Uaktualnienie zmian na podstawie `git commit -m 'Add amazing feature'`
4. Wysyłanie gałęzi zaktualizowanej `git push origin feature/amazing-feature`
5. Otwieranie Zarządzania Pull-Request

Patrz [[CONTRIBUTING.md](CONTRIBUTING.md)] dla szczegółów dokumentacji.

### Publikacja Nowej Wersji

```bash
# utworzenie nowej wersji — [X57X]npm publish happens automatycznie
...
## Osoby zwracające uwagę w czasie

## [![Historia gwizd](https://starchart.cc/diegosouzapw/OmniRoute.svg?variant=adaptive)](https://starchart.cc/diegosouzapw/OmniRoute)
