...
| Step | การดำเนินการ                                       | Providers Unlocked                                                 |
| ---- | -------------------------------------------------- | ------------------------------------------------------------------ |
...
| Tier               | ผู้ให้บริการ               | Cost                     | Quota Reset      | Best For                          |
| ------------------ | -------------------------- | ------------------------ | ---------------- | --------------------------------- |
| **💳 SUBSCRIPTION** | Claude Code (Pro)          | $20/mo                   | 5h + weekly      | Already subscribed                |
|                    | Codex (Plus/Pro)           | $20-200/mo               | 5h + weekly      | OpenAI users                      |
|                    | Gemini CLI                 | **FREE**                 | 180K/mo + 1K/day | Everyone!                         |
|                    | นักบิน GitHub              | $10-19/mo                | Monthly          | GitHub users                      |
...
|                    | DeepSeek V3.2              | $0.27/$1.10 per 1M       | ไม่มี            | Best price/quality reasoning      |
|                    | xAI Grok-4 Fast            | **$0.20/$0.50 per 1M** 🆕 | ไม่มี            | Fastest + tool calling, ultralow  |
|                    | xAI Grok-4 (standard)      | $0.20/$1.50 per 1M 🆕     | ไม่มี            | Reasoning flagship from xAI       |
|                    | Mistral                    | Free trial + paid        | อัตราจำกัด       | European AI                       |
|                    | OpenRouter                 | Pay-per-use              | ไม่มี            | 100+ models aggr.                 |
...
|                    | Kimi K2.5 (Moonshot API) 🆕 | Pay-per-use              | ไม่มี            | Direct Moonshot API access        |
...
|                    | Scaleway AI 🆕              | **$0** (1M tokens total) | อัตราจำกัด       | EU/GDPR, Qwen3 235B, Llama 70B    |
...
| Model               | คำนำหน้า | Limit         | ขีดจำกัดอัตรา         |
| ------------------- | -------- | ------------- | --------------------- |
...
| Tier       | ขีดจำกัดรายวัน | ขีดจำกัดอัตรา | หมายเหตุ                                               |
| ---------- | -------------- | ------------- | ------------------------------------------------------ |
...
| Tier | ขีดจำกัดรายวัน    | ขีดจำกัดอัตรา    | หมายเหตุ                                    |
| ---- | ----------------- | ---------------- | ------------------------------------------- |
| ฟรี  | **1M tokens/day** | 60K TPM / 30 RPM | World's fastest LLM inference; resets daily |
...
| Tier | ขีดจำกัดรายวัน | ขีดจำกัดอัตรา    | หมายเหตุ                                  |
| ---- | -------------- | ---------------- | ----------------------------------------- |
| ฟรี  | **14.4K RPD**  | 30 RPM per model | No credit card; 429 on limit, not charged |
...
| Model                         | คำนำหน้า | Daily Free Quota | หมายเหตุ                |
| ----------------------------- | -------- | ---------------- | ----------------------- |
...
| Model      | คำนำหน้า | ขีดจำกัดอัตรา | Provider Behind    |
| ---------- | -------- | ------------- | ------------------ |
...
| Tier | Daily Neurons | Equivalent Usage                        | หมายเหตุ                |
| ---- | ------------- | --------------------------------------- | ----------------------- |
| ฟรี  | **10,000**    | ~150 LLM resp / 500s audio / 15K embeds | Global edge, 50+ models |
...
| Tier | Free Quota    | Location     | หมายเหตุ                            |
| ---- | ------------- | ------------ | ----------------------------------- |
| ฟรี  | **1M tokens** | 🇫🇷 Paris, EU | No credit card needed within limits |
...
| ผู้ให้บริการ     | Free Credits           | Best Model                                   | ขีดจำกัดอัตรา                |
| ---------------- | ---------------------- | -------------------------------------------- | ---------------------------- |
...
| การถอดเสียง             | `/v1/audio/transcriptions` — 7 providers (Deepgram Nova 3, AssemblyAI, Groq Whisper, HuggingFace, ElevenLabs, OpenAI, Azure), auto-language detection, MP4/MP3/WAV support |
...
| กำหนดเอง   | Custom JS function returns true/false            | `(output) => output.length > 10` |
