# 🚀 OmniRoute — Білльовий AI Ґateway

### Не зупиняйтесь, програмувати! Відповідальний маршрутизація до **безкоштовних та вільних моделей AI** з автоматичною відмовою.

_Ваш універсальний API-проксі — одна точка входу, 67+ надання, жодна зупинка
часу. Тепер з агентним управлінням MCP & A2A._

**Чатова завершення пропозицій • Вбудовані ввігнені • Образне створення • Відео
• Музика • Диктофон • Ранкінг відновлення • **Веб-пошук** • Сервер MCP •
Протокол A2A • 100% TypeScript**
...
[![npm
версія](https://img.shields.io/npm/v/omniroute?color=cb3837&logo=npm)](https://www.npmjs.com/package/omniroute)
[![npm
завантажено](https://img.shields.io/npm/dm/omniroute?color=cb3837&logo=npm&label=npm%20downloads)](https://www.npmjs.com/package/omniroute)
[![Docker
...
[![Docker
Підтягнення](https://img.shields.io/docker/pulls/diegosouzapw/omniroute?logo=docker&color=2496ED&label=docker%20pulls)](https://hub.docker.com/r/diegosouzapw/omniroute)
[![Ліцензія](https://img.shields.io/github/license/diegosouzapw/OmniRoute)](https://github.com/diegosouzapw/OmniRoute/blob/main/LICENSE)
...
[🌐 Веб-сайт](https://omniroute.online) • [🚀 Quick Start](#-quick-start) • [💡
Функції](#-key-features) • [📖 Документи](#-documentation) • [💰
Ціна](#-pricing-at-a-glance) • [💬
WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)

</div>

🌐 **Доступно в:** 🇺🇸 [Англійська](README.md) | 🇧🇷 [Портoghese
(Бразилія)](docs/i18n/pt-BR/README.md) | 🇪🇸 [Іспанська](docs/i18n/es/README.md)
| 🇫🇷 [Французька](docs/i18n/fr/README.md) | 🇮🇹
[Італійська](docs/i18n/it/README.md) | 🇷🇺 [Російська](docs/i18n/ru/README.md) |
🇨🇳 [Китайська (спрощений)](docs/i18n/zh-CN/README.md) | 🇩🇪
[Німецька](docs/i18n/de/README.md) | 🇮🇳 [Урду](docs/i18n/in/README.md) | 🇹🇭
[Тайська](docs/i18n/th/README.md) | 🇺🇦 [Українська](docs/i18n/uk-UA/README.md) |
🇸🇦 [Арабська](docs/i18n/ar/README.md) | 🇯🇵 [Японська](docs/i18n/ja/README.md) |
🇻🇳 [В'єтнамська](docs/i18n/vi/README.md) | 🇧🇬
[Кирилиця-Bulgaria](docs/i18n/bg/README.md) | 🇩🇰
[Датська](docs/i18n/da/README.md) | 🇫🇮 [Фінська](docs/i18n/fi/README.md) | 🇮🇱
[Іврит](docs/i18n/he/README.md) | 🇭🇺 [Мадярська](docs/i18n/hu/README.md) | 🇮🇩
[Індонезійська](docs/i18n/id/README.md) | 🇰🇷 [Корейська](docs/i18n/ko/README.md)
| 🇲🇾 [Малайська](docs/i18n/ms/README.md) | 🇳🇱
[Нідерландська](docs/i18n/nl/README.md) | 🇳🇴 [Норвезька](docs/i18n/no/README.md)
| 🇵🇹 [Португальська (Португалія)](docs/i18n/pt/README.md) | 🇷🇴
[Румунська](docs/i18n/ro/README.md) | 🇵🇱 [Польська](docs/i18n/pl/README.md) | 🇸🇰
[Словаччина](docs/i18n/sk/README.md) | 🇸🇪 [Шведська](docs/i18n/sv/README.md) |
🇵🇭 [Філіппінська](docs/i18n/phi/README.md) | 🇨🇿
[Чехська](docs/i18n/cs/README.md)

---

## 🆕 Що нового у в3.0.0

> **Підвищення з v2.9.5?** — Переглянути [повний список
> змін](CHANGELOG.md#300--2026-03-22-release-candidate--not-yet-merged-to-main)
> для всіх змін.

| Державність                        | Історія зміни                                                                                                                                                                                                 |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🔒 **CodeQL Безпека**               | Вирішено 10+ попереджень CodeQL: поліноміальні оновлення, небезпечна випадковість, лікування вбудованих інструкцій                                                                                            |
| ✅ **Реалізація маршрутів**         | Всі 176 API-відповіді現在 валідуються із застосуванням Zod схеми + `validateBody()` — CI ` перевірка: відправлення-валідність:t06` виконуються                                                                  |
| 🐛 **omniModel Випромінення метки** | Внутрішні <omnimodel> метки більше не виводяться до клієнтів у SSE поточних ознобів(# 585)</omnimodel>                                                                                                        |
| 🔑 **Зареєстровані ключі API**      | Автоматичне надання API-ключів за допомогою `POST /api/v1/registered-keys` із застосуванням квоти на основі надання/акаунту, ідентичності, зберігання SHA-256 та можливістю звітування про проблеми на GitHub |
| 🎨 **Прапори надаються**            | 130+ provider logos via `@lobehub/icons` (SVG) with PNG → generic fallback chain                                                                                                                              |
...
- **Dashboard i18n — 30 Languages** — All 500+ keys translated including Arabic,
  Bulgarian, Danish, German, Spanish, Finnish, French, Hebrew, Hindi, Hungarian,
  Indonesian, Italian, Japanese, Korean, Malay, Dutch, Norwegian, Polish,
  Portuguese (PT/BR), Romanian, Russian, Slovak, Swedish, Thai, Ukrainian,
  Vietnamese, Chinese, Filipino, English
...
AI isn't just chat completion. Devs need to generate images, transcribe audio,
create embeddings for RAG, rerank documents, and moderate content. Each API has
a different endpoint and format.

**How OmniRoute solves it:**

- **Embeddings** — `/v1/embeddings` with 6 providers and 9+ models
- **Image Generation** — `/v1/images/generations` with 10 providers and 20+
  models (OpenAI, xAI, Together, Fireworks, Nebius, Hyperbolic, NanoBanana,
  Antigravity, SD WebUI, ComfyUI)
- **Text-to-Video** — `/v1/videos/generations` — ComfyUI (AnimateDiff, SVD) and
  SD WebUI
- **Text-to-Music** — `/v1/music/generations` — ComfyUI (Stable Audio Open,
  MusicGen)
- **Audio Transcription** — `/v1/audio/transcriptions` — Whisper + Nvidia NIM,
  HuggingFace, Qwen3
- **Text-to-Speech** — `/v1/audio/speech` — ElevenLabs, Nvidia NIM, HuggingFace,
  Coqui, Tortoise, Qwen3, **Inworld**, **Cartesia**, **PlayHT**, + existing
  providers
...
Developers want to know which model is best for their use case — code,
translation, reasoning — but comparing manually is slow. No integrated eval
tools exist.

**How OmniRoute solves it:**

- **LLM Evaluations** — Golden set testing with 10 pre-loaded cases covering
  greetings, math, geography, code generation, JSON compliance, translation,
  markdown, safety refusal
- **4 Match Strategies** — `exact`, `contains`, `regex`, `custom` (JS function)
- **Translator Playground Test Bench** — Batch testing with multiple inputs and
  expected outputs, cross-provider comparison
...
Agent workflows need both direct replies and long-running streamed execution
...
Operational teams need to know if MCP is actually alive, not just whether an API
is reachable.

**How OmniRoute solves it:**

- Runtime heartbeat file with PID, timestamps, transport, tool count, and scope
  mode
...
| Зображення               | Tag      | Розмір | Description           |
| ------------------------ | -------- | ------ | --------------------- |
...
| Tier               | Провайдер                  | Cost                     | Quota Reset      | Best For                          |
| ------------------ | -------------------------- | ------------------------ | ---------------- | --------------------------------- |
| **💳 SUBSCRIPTION** | Claude Code (Pro)          | $20/mo                   | 5h + weekly      | Already subscribed                |
|                    | Codex (Plus/Pro)           | $20-200/mo               | 5h + weekly      | OpenAI users                      |
|                    | Gemini CLI                 | **FREE**                 | 180K/mo + 1K/day | Everyone!                         |
|                    | Копілот GitHub             | $10-19/mo                | Monthly          | GitHub users                      |
...
|                    | DeepSeek V3.2              | $0.27/$1.10 per 1M       | Жодного          | Best price/quality reasoning      |
|                    | xAI Grok-4 Fast            | **$0.20/$0.50 per 1M** 🆕 | Жодного          | Fastest + tool calling, ultralow  |
|                    | xAI Grok-4 (standard)      | $0.20/$1.50 per 1M 🆕     | Жодного          | Reasoning flagship from xAI       |
|                    | Mistral                    | Free trial + paid        | Тариф обмежений  | European AI                       |
|                    | OpenRouter                 | Pay-per-use              | Жодного          | 100+ models aggr.                 |
...
|                    | Kimi K2.5 (Moonshot API) 🆕 | Pay-per-use              | Жодного          | Direct Moonshot API access        |
...
|                    | Scaleway AI 🆕              | **$0** (1M tokens total) | Тариф обмежений  | EU/GDPR, Qwen3 235B, Llama 70B    |
...
| Модель              | Префікс | Limit         | Обмеження швидкості   |
| ------------------- | ------- | ------------- | --------------------- |
...
| Tier       | Денний ліміт | Обмеження швидкості | Примітки                                               |
| ---------- | ------------ | ------------------- | ------------------------------------------------------ |
| Free (Dev) | No token cap | **~40 RPM**         | 70+ models; transitioning to pure rate limits mid-2025 |

Popular free models: `moonshotai/kimi-k2.5` (Kimi K2.5), `z-ai/glm4.7` (GLM
...
| Tier        | Денний ліміт      | Обмеження швидкості | Примітки                                    |
| ----------- | ----------------- | ------------------- | ------------------------------------------- |
| безкоштовно | **1M tokens/day** | 60K TPM / 30 RPM    | World's fastest LLM inference; resets daily |
...
| Tier        | Денний ліміт  | Обмеження швидкості | Примітки                                  |
| ----------- | ------------- | ------------------- | ----------------------------------------- |
| безкоштовно | **14.4K RPD** | 30 RPM per model    | No credit card; 429 on limit, not charged |
...
| Модель                        | Префікс | Daily Free Quota | Примітки                |
| ----------------------------- | ------- | ---------------- | ----------------------- |
...
> 100% free while in public beta. Sign up at
> [longcat.chat](https://longcat.chat) with email or phone. Resets daily 00:00
> UTC.

### 🟢 POLLINATIONS AI (No API Key Required) 🆕

| Модель     | Префікс | Обмеження швидкості | Provider Behind    |
| ---------- | ------- | ------------------- | ------------------ |
...
| Tier        | Daily Neurons | Equivalent Usage                        | Примітки                |
| ----------- | ------------- | --------------------------------------- | ----------------------- |
| безкоштовно | **10,000**    | ~150 LLM resp / 500s audio / 15K embeds | Global edge, 50+ models |
...
| Tier        | Free Quota    | Location     | Примітки                            |
| ----------- | ------------- | ------------ | ----------------------------------- |
| безкоштовно | **1M tokens** | 🇫🇷 Paris, EU | No credit card needed within limits |
...
| Провайдер        | Free Credits           | Best Model                                   | Обмеження швидкості          |
| ---------------- | ---------------------- | -------------------------------------------- | ---------------------------- |
...
When quota, rate, or health fails, OmniRoute automatically moves to the next
candidate without manual switching.
...
- Dashboards include actions for day-2 ops (combo toggles, breaker resets, task
  cancellation)
...
> 📖 **[MCP Server README](open-sse/mcp-server/README.md)** — Tool reference, IDE
> configs, and client examples
> 
> 📖 **[A2A Server README](src/lib/a2a/README.md)** — Skills, JSON-RPC methods,
> streaming, and task lifecycle

## 🧪 Evaluations (Evals)

OmniRoute includes a built-in evaluation framework to test LLM response quality
against a golden set. Access it via **Analytics → Evals** in the dashboard.
...
| звичай     | Custom JS function returns true/false            | `(output) => output.length > 10` |
