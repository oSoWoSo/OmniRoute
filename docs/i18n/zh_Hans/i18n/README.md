...
| Tier               | 提供商                        | 成本                       | Quota Reset      | Best For                          |
| ------------------ | -------------------------- | ------------------------ | ---------------- | --------------------------------- |
...
|                    | DeepSeek V3.2              | $0.27/$1.10 per 1M       | 无                | Best price/quality reasoning      |
|                    | xAI Grok-4 Fast            | **$0.20/$0.50 per 1M** 🆕 | 无                | Fastest + tool calling, ultralow  |
|                    | xAI Grok-4 (standard)      | $0.20/$1.50 per 1M 🆕     | 无                | Reasoning flagship from xAI       |
|                    | Mistral                    | Free trial + paid        | 速率有限             | European AI                       |
|                    | OpenRouter                 | Pay-per-use              | 无                | 100+ models aggr.                 |
...
|                    | Kimi K2.5 (Moonshot API) 🆕 | Pay-per-use              | 无                | Direct Moonshot API access        |
...
|                    | Scaleway AI 🆕              | **$0** (1M tokens total) | 速率有限             | EU/GDPR, Qwen3 235B, Llama 70B    |
...
| Tier | 每日限额              | 速率限制             | 注释                                          |
| ---- | ----------------- | ---------------- | ------------------------------------------- |
| 免费   | **1M tokens/day** | 60K TPM / 30 RPM | World's fastest LLM inference; resets daily |
...
| Tier | 每日限额          | 速率限制             | 注释                                        |
| ---- | ------------- | ---------------- | ----------------------------------------- |
| 免费   | **14.4K RPD** | 30 RPM per model | No credit card; 429 on limit, not charged |
...
| Tier | Daily Neurons | Equivalent Usage                        | 注释                      |
| ---- | ------------- | --------------------------------------- | ----------------------- |
| 免费   | **10,000**    | ~150 LLM resp / 500s audio / 15K embeds | Global edge, 50+ models |
...
| Tier | Free Quota    | Location     | 注释                                  |
| ---- | ------------- | ------------ | ----------------------------------- |
| 免费   | **1M tokens** | 🇫🇷 Paris, EU | No credit card needed within limits |
...
| 提供商              | Free Credits           | Best Model                                   | 速率限制                         |
| ---------------- | ---------------------- | -------------------------------------------- | ---------------------------- |
...
| CLI 指纹匹配                                  | Per-provider header/body ordering to match native CLI signatures — toggle per provider in Settings > Security. **Your proxy IP is preserved**                                                                                           |
...
| CLI 指纹匹配                           | Matches native CLI request signatures — **reduces ban risk while preserving proxy IP** |
...
| 自定义        | Custom JS function returns true/false            | `(output) => output.length > 10` |
