...
| Step | hành động                                          | Providers Unlocked                                                 |
| ---- | -------------------------------------------------- | ------------------------------------------------------------------ |
...
| Hình ảnh                 | Tag      | Kích thước | Description           |
| ------------------------ | -------- | ---------- | --------------------- |
...
|                    | Phi công phụ GitHub        | $10-19/mo                | Monthly          | GitHub users                      |
...
|                    | DeepSeek V3.2              | $0.27/$1.10 per 1M       | không có         | Best price/quality reasoning      |
|                    | xAI Grok-4 Fast            | **$0.20/$0.50 per 1M** 🆕 | không có         | Fastest + tool calling, ultralow  |
|                    | xAI Grok-4 (standard)      | $0.20/$1.50 per 1M 🆕     | không có         | Reasoning flagship from xAI       |
|                    | Mistral                    | Free trial + paid        | Tỷ lệ giới hạn   | European AI                       |
|                    | OpenRouter                 | Pay-per-use              | không có         | 100+ models aggr.                 |
...
|                    | Kimi K2.5 (Moonshot API) 🆕 | Pay-per-use              | không có         | Direct Moonshot API access        |
...
|                    | Scaleway AI 🆕              | **$0** (1M tokens total) | Tỷ lệ giới hạn   | EU/GDPR, Qwen3 235B, Llama 70B    |
...
| người mẫu           | Tiền tố | Limit         | Giới hạn tỷ lệ        |
| ------------------- | ------- | ------------- | --------------------- |
...
| Tier       | Giới hạn hàng ngày | Giới hạn tỷ lệ | Ghi chú                                                |
| ---------- | ------------------ | -------------- | ------------------------------------------------------ |
...
| Tier     | Giới hạn hàng ngày | Giới hạn tỷ lệ   | Ghi chú                                     |
| -------- | ------------------ | ---------------- | ------------------------------------------- |
| miễn phí | **1M tokens/day**  | 60K TPM / 30 RPM | World's fastest LLM inference; resets daily |
...
| Tier     | Giới hạn hàng ngày | Giới hạn tỷ lệ   | Ghi chú                                   |
| -------- | ------------------ | ---------------- | ----------------------------------------- |
| miễn phí | **14.4K RPD**      | 30 RPM per model | No credit card; 429 on limit, not charged |
...
| người mẫu                     | Tiền tố | Daily Free Quota | Ghi chú                 |
| ----------------------------- | ------- | ---------------- | ----------------------- |
...
| người mẫu  | Tiền tố | Giới hạn tỷ lệ | Provider Behind    |
| ---------- | ------- | -------------- | ------------------ |
...
| Tier     | Daily Neurons | Equivalent Usage                        | Ghi chú                 |
| -------- | ------------- | --------------------------------------- | ----------------------- |
| miễn phí | **10,000**    | ~150 LLM resp / 500s audio / 15K embeds | Global edge, 50+ models |
...
| Tier     | Free Quota    | Location     | Ghi chú                             |
| -------- | ------------- | ------------ | ----------------------------------- |
| miễn phí | **1M tokens** | 🇫🇷 Paris, EU | No credit card needed within limits |
...
| Provider         | Free Credits           | Best Model                                   | Giới hạn tỷ lệ               |
| ---------------- | ---------------------- | -------------------------------------------- | ---------------------------- |
...
| Chiến lược | Description                                      | Example                          |
| ---------- | ------------------------------------------------ | -------------------------------- |
...
| tùy chỉnh  | Custom JS function returns true/false            | `(output) => output.length > 10` |
